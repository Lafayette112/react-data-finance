...
const Cards = () => {
  return (
    <div className='w-full py-[10rem] px-4 bg-white' id='ressources'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                <img className='w-20 mx-auto mt-[-3rem] bg-white' src={Single} alt="/" />
                <h3 className='font-bold text-2xl text-center py-8'>Single User</h3>
                <p className='text-center text-bold text-4xl'>$149</p>
            ...
            <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 my-8 md:my-0 rounded-lg hover:scale-105 duration-300'>
                ...
                <h3 className='font-bold text-2xl text-center py-8'>Partnership</h3>
                <p className='text-center text-bold text-4xl'>$199</p>
                <div className='text-center font-medium'>
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <h3 className='font-bold text-2xl text-center py-8'>Group Account</h3>
                <p className='text-center text-bold text-4xl'>$299</p>
                <div className='text-center font-medium'>
                    <p className='py-2 border-b mx-8 mt-8'>500 GB Storage</p>
